...
export const METRIC_CONFIG = {
  ...
  pace: { icon: "⏱️", label: "Pace", iconYOffset: 0 },
  speed: { icon: "🚀", label: "Speed", iconYOffset: 0 },
  grade: { icon: "📈", label: "Grade", iconYOffset: 0 },
  verticalSpeed: { icon: "⬆️", label: "Vertical Speed", iconYOffset: 0 },
} as const;
